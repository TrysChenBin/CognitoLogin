...
public class AuthenticationManager : MonoBehaviour {
  ...
  private const string IdentityPool = "ap-northeast-1:23b10feb-975c-49ba-8baf-b7c0e6ca58e0";
  private const string AppClientID = "3mvs174oskmsv2c4b4rkuo1es";
  private const string userPoolId = "ap-northeast-1_KXuOYlnGS";
  ...
  private CognitoUser _user;
   ...
   public async Task<bool> Verification(string email, string code) {
      // Debug.Log("VerificationRequest: " + code);
      ...
      try {
         ConfirmSignUpResponse confirmSignUpResponse = await _provider.ConfirmSignUpAsync(confirmSignUpRequest);
         Debug.Log("Verify successful");
         return true;
      }
      catch (Exception e) {
         Debug.Log("Verify failed, exception: " + e);
         return false;
      }
   }
